...
//        print_r($count_visit);
    ...
    public function begame2()
    {
        ...
        $active_games = $this->active_games_model->all($this->input->get('type'),$this->input->get('gid'),$this->input->get('order'),$_GET['p'],$_GET['end']);
...
//                        $return['title'] = '很遗憾，木有中奖，不要灰心 再玩一次还能参与抽奖';
    ...
    {
        $this->load->model('active_games_model');
        $data['list'] = $this->active_games_model->all($this->input->get('type'),$this->input->get('gid'),$this->input->get('order'),$_GET['p'],$_GET['end']);
