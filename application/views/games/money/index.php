...
<HEAD>
    ...
    <STYLE type="text/css">
        ...
        .welcome-bg {
            ...
            right: 0;
            bottom: 0;
            background: url(http://ww2.sinaimg.cn/mw1024/81345eabgw1ei0jyahwhwj20gp0qzt9s.jpg) center center no-repeat;
        ...
        .t1, .t2, .t3, .t4, .t5 {
            ...
            background-image: url(files/rmb.png);
        }

        .tt1, .tt2, .tt3, .tt4, .tt5 {
            background-size: auto 86%;
            background-image: url(files/laugh.gif);
        }
...
<SCRIPT type="text/javascript">
    window.shareData = {
        ...
        "timeLineLink": "http://weixinad.lejuy.com/games/money/",
        "tTitle": "财神到，小伙伴们快来捡钱！",
        "tContent": "快来一起捡钱玩！"
    };
...
<DIV class="SHADE BOX-M" id="welcome">
    ...
    <DIV class="FILL BOX-M" style="left: 0px; top: 0px; right: 0px; bottom: 0px; position: absolute; z-index: 5;">
        <DIV style="margin: 0px 8% 0px 9%;">
            <DIV style="color: rgb(254, 240, 2); font-size: 2.6em;">捡钱大作战</DIV>
            <BR>

            <DIV
                style="color: rgb(255, 255, 255); line-height: 1.5em; font-size: 2.2em;">天降横财，看看你有没有财运？！
            </DIV>
            <BR><BR>

            <DIV class="btn loading" id="ready-btn"
                 style="margin: 0px auto; width: 8em; height: 1.7em; color: rgb(255, 255, 255); line-height: 1.7em; font-size: 2.2em; display: inline-block;"></DIV>
        </DIV>
    </DIV>
</DIV>
...
<DIV id="share-wx">
    <P style="text-align: right; padding-left: 10px;"><IMG id="share-wx-img"
                                                           style="padding-right: 25px; max-width: 280px;"
