...
<div id="container">
    <div class="grid">
        <div class="page hide" id="index" style="display: block;">
            <form action="?c=ins" id="f" method="post" enctype="multipart/form-data"
                  style="width:50%; margin:0 auto; float:left;">
                生成标题：<input type="text" value="全民寻找房祖名" name="title" onClick="this.value=''" size="50"/><br/>
                生成简介：<input type="text" value="虽然柯少向龙叔保证不会带坏房祖名,但龙叔强烈要求你找回祖名。" size="50" name="content"
