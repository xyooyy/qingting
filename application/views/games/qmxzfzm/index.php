<?php
$ary['title'] = "全民寻找房祖名";
$ary['content'] = "全民寻找房祖名！虽然柯少向龙叔保证不会带坏房祖名,但龙叔强烈要求你找回祖名.";
$ary['img1'] = "/upload/games/fantrue.png";
$ary['img2'] = "/upload/games/fantrue.png";
?>
<html>
<head>
    <meta charset="UTF-8">
...
<script id="tpl" type="text/html">
    ...
    <div id="bdfootpanel">
        <a href="http://mp.weixin.qq.com/s?__biz=MjM5MjEwNjkwNw==&mid=200328205&idx=2&sn=7587cfa863d47ae2f14398f5cc0c8d19#rd"><img
                src="ad.jpg" width="100%" height="50px"></a>
    </div>
...
<script>
    var _lang = {
            ...
            zh: {
                title: "<?php echo $ary['title']?>",
                help_txt: "<?php echo $ary['content']?>",
                score: "过关：",
                btn_pause: "暂停",
                btn_start: "开始游戏",
                btn_reTry: "再来一次",
                ...
                e = {
                    ...
                    render: function (e, f) {
                        ...
                        a.find(b).css("background-color", i[1]).data("type", "b").css({
                            "background": "url(<?php echo $ary['img2']?>)" + j[1],
                            "background-size": "cover"
                        }), a.find(b).eq(h).css("background-color", j[1]).data("type", "a").css({
                            "background": "url(<?php echo $ary['img1']?>)" + j[1],
                            "background-size": "cover"
                        });
                    },
                    getColor: function (a) {
