  ...
  <div class="con">
        ...
        <div class="con_info">
            ...
            <div class="right_info">
              <div class="info"> 
                    <a href="./edit_my?mid=<?php echo $mid?>"><dl>
                      <dt><img src="/public/images/info1.jpg" /></dt>
                      <dd>编辑应用</dd>
                    </dl></a>
                    <a href="/games/<?php echo $keyname?>?mid=<?php echo $mid?>"><dl>
                    ...
                    <a href="#" onclick="if(confirm('删除后不可恢复')){location.href='./del_my?mid=<?php echo $mid?>'}"><dl>
