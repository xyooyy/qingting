                            ...
                            <input type="hidden" name="id" value="<?php echo $_GET['id']?>">
                                <div class="prize-info">
                                    <div class="form-group convertCode">
                                        ...
                                        <input class="input-class input-name" type="text" name="convertCodePrefix" placeholder="兑换码前缀（提示:通常为4个字母）" onkeyup="this.value=this.value.replace(/[^\da-zA-Z]/g,&#39;&#39;);" maxlength="4" value="<?php echo $prize_t?$prize_t:'qt'?>">
                                    </div>
                                    <div class="form-group">
                                        <label>
                                            每天抽奖次数
                                        </label>
                                        <input class="input-class input-name" type="url" name="lotteryTotal" placeholder="每天抽奖次数" onkeyup="this.value=this.value.replace(/[\D]/g,&#39;&#39;);if(parseInt(this.value)&lt;0)this.value=0;" min="0" onblur="if(parseInt(this.value)&lt;0)this.value=0;" maxlength="5" value="<?php echo $prize_c?$prize_c:3?>">
                                    </div>
                                    <div class="form-group">
                                        <label>
                                            每天派奖个数
                                        </label>
                                        <input class="input-class input-name" type="url" name="todayLotteryTotal" placeholder="每天派奖个数" onkeyup="this.value=this.value.replace(/[\D]/g,&#39;&#39;);if(parseInt(this.value)&lt;0)this.value=0;" min="0" onblur="if(parseInt(this.value)&lt;0)this.value=0;" maxlength="8" value="<?php echo $prize_c1?$prize_c1:100?>">
                                    </div>
                                ...
                                <div class="prize-set">
                                    ...
                                    <div class="prize-input" style="display: none;">
                                        ...
                                        <form action="/index.php/prize/add" method="post" enctype="multipart/form-data" target="pr"  id="prize_form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="input-class input-name" type="text" name="p_title" id="p_title">
                                        </div>
                                        <div class="form-group">
                                            <label>
                                                奖品名称
                                            </label>
                                            <input class="input-class input-name" type="text" name="p_name" id="p_name">
                                        </div>
                                        <div class="form-group">
                                            <label>
                                                奖品数量
                                            </label>
                                            <input class="input-class input-name" type="text" name="p_count" id="p_count" onkeyup="this.value=this.value.replace(/[\D]/g,&#39;&#39;);if(parseInt(this.value)&lt;0)this.value=0;" min="0" onblur="if(parseInt(this.value)&lt;0)this.value=0;" maxlength="8">
                                        </div>
                                        <div class="form-group">
                                            <label>
                                                中奖概率
                                            </label>
                                            <input class="input-class input-name" type="text" name="p_size" id="p_size" onblur="var userreg=/^[0-9]+([.]{1}[0-9]{1,2})?$/;if(!userreg.test(this.value))this.value=&#39;&#39;;if(parseInt(this.value)&lt;0)this.value=0;else if((parseInt(this.value)&gt;=100))this.value=100;" min="0" placeholder="数字和小数点，两位小数">%
                                        </div>
                                        <div class="form-group">
                                            <label>
                                                奖品链接
                                            </label>
                                            <input class="input-class input-name" type="url" name="p_href" id="p_href" placeholder="请输入奖品链接">
                                        </div>
                                        <div class="form-group form-group-check">
                                            <label>
                                                奖品图片
                                            ...
                                            <div class="form-single-upload">
                                                <div class="form-fileupload litpci-load">
                                                    <img src="/public/active/css/images/s.png" id="jiangpin_img" style="width:188px; height:205px;" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="javascript:;" class="save-set1"  onClick="$('#fimg').val($('#jiangpin_img').attr('src'));$('#prize_form').submit();setTimeout(loadprize,2000);">
                                                保存设置
                                            </a>
                                        </div>
...
<script>
  ...
  function loadprize(){ 
	...
	//alert(timestamp);
    $(".prize-table").load('/index.php/prize/index?tm='+timestamp+'&id=<?php echo $_GET['id']?>');
  }
</script>
<script> 
  var isshow=1;
  $("#addchou").click(function(){
	   if(isshow==1)$('.prize-input.').show();isshow=0;
	   else{
		   $('.prize-input.').hide();isshow=1;
		   } 
	  })
</script>
</body></html>