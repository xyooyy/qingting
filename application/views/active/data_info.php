                    ...
                    <div class="bor stat-game-con">
                        ...
                        <div id="visit_record" style="width:1000px;height:400px" data-highcharts-chart="1">
                            <div class="highcharts-container" id="highcharts-2"
                                 style="position: relative; overflow: hidden; width: 1000px; height: 400px; text-align: left; line-height: normal; z-index: 0; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
                                <svg version="1.1"
                                    ...
                                    <defs>
                                        <clipPath id="highcharts-3">
                                            <rect x="0" y="0" width="927" height="290"></rect>
                                        </clipPath>
                                    ...
                                    <rect x="0" y="0" width="1000" height="400" strokeWidth="0" fill="#FFFFFF"
                                          class=" highcharts-background"></rect>
                                    <g class="highcharts-button" style="cursor:default;" stroke-linecap="round"
                                       transform="translate(966,10)"><title>Chart context menu</title>
                                    ...
                                    <g class="highcharts-grid" zIndex="1">
                                        <path fill="none" d="M 63 200.5 L 990 200.5" stroke="#C0C0C0" stroke-width="1"
                                              zIndex="1" opacity="1"></path>
                                    </g>
                                    <g class="highcharts-axis" zIndex="2">
                                        <path fill="none" d="M 526.5 345 L 526.5 355" stroke="#C0D0E0" stroke-width="1"
                                              opacity="1"></path>
                                        <text x="526.5" zIndex="7" text-anchor="middle" transform="translate(0,0)"
                                              class=" highcharts-xaxis-title" style="color:#707070;fill:#707070;"
                                              visibility="visible" y="383">小时(H)
                                        </text>
                                        <path fill="none" d="M 63 345.5 L 990 345.5" stroke="#C0D0E0" stroke-width="1"
                                              zIndex="7" visibility="visible"></path>
                                    </g>
                                    <g class="highcharts-axis" zIndex="2">
                                        <text x="24.0625" zIndex="7" text-anchor="middle"
                                              transform="translate(0,0) rotate(270 24.0625 200)"
                                              class=" highcharts-yaxis-title" style="color:#707070;fill:#707070;"
                                              visibility="visible" y="200">
                                            <tspan>分钟 (M)</tspan>
                                        </text>
                                    </g>
                                    <g class="highcharts-series-group" zIndex="3">
                                        <g class="highcharts-series" visibility="visible" zIndex="0.1"
                                           transform="translate(63,55) scale(1 1)" clip-path="url(#highcharts-3)"></g>
                                        <g class="highcharts-markers highcharts-tracker" visibility="visible"
                                           zIndex="0.1" transform="translate(63,55) scale(1 1)" clip-path="none"
                                           style="">
                                            <path fill="rgba(223, 83, 83, .5)"
                                                  d="M 463 130 C 482.98 130 482.98 160 463 160 C 443.02 160 443.02 130 463 130 Z"></path>
                                        </g>
                                    </g>
                                    <text x="500" text-anchor="middle" class="highcharts-title" zIndex="4"
                                          style="color:#636363;font-size:30px;font-family:Microsoft YaHei;fill:#636363;width:936px;"
                                          y="36">
                                        <tspan>活动参与者来访记录 2015-05-25</tspan>
                                    </text>
                                    <g class="highcharts-axis-labels highcharts-xaxis-labels" zIndex="7">
                                        <text x="526.5" text-anchor="middle"
                                              style="color:#606060;cursor:default;font-size:11px;fill:#606060;" y="366"
                                              opacity="1">13
                                        </text>
                                    </g>
                                    <g class="highcharts-axis-labels highcharts-yaxis-labels" zIndex="7">
                                        <text x="48" text-anchor="end"
                                              style="width:310px;color:#606060;cursor:default;font-size:11px;fill:#606060;"
                                              y="206.5" opacity="1">56
                                        </text>
                                    </g>
                                ...
                                <div class="highcharts-contextmenu"
                                    ...
                                    <div
                                        style="-webkit-box-shadow: rgb(136, 136, 136) 3px 3px 10px; box-shadow: rgb(136, 136, 136) 3px 3px 10px; border: 1px solid rgb(160, 160, 160); padding: 5px 0px; background: rgb(255, 255, 255);">
                                        <div
                                            style="cursor: pointer; padding: 0px 10px; color: rgb(48, 48, 48); font-size: 11px; background: none;">
                                            Print chart
                                        </div>
                                        <hr>
                                        <div
