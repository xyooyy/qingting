                                    ...
                                    <div class="layout-set" id="bg-set" style="display: block">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active" id="home">
                                                <div class="set-main">
                                                    <div id="target2"><br><br><div class="setComn-label">遮罩层透明度：</div><div class="toolbar" style="border-radius: 6px; display: inline-block; margin-top: 7px; margin-left: 0px; width: 100px; height: 6px; touch-action: pan-y; -webkit-user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); background-color: rgb(197, 197, 197);"><div class="toolprogress" style="cursor:pointer;border-radius:5px;top;0;left:-1px;height:100%;width:100%;"><div style="cursor:pointer;box-shadow: 0px 1px 4px #a0a0a0;float:right;box-shadow: 0px 1px 2px #a0a0a0;background:-webkit-gradient(linear, 0% 0%, 0% 80%, from(#FFFFFF), to(#F0F0F0));background:-moz-linear-gradient(top, #FFFFFF, #F0F0F0);background:-o-linear-gradient(top, #FFFFFF, #F0F0F0);background:-ms-linear-gradient(top, #FFFFFF, #F0F0F0); background:-webkit-gradient(linear, 0% 0%, 0% 80%,from(#FFFFFF), to(#F0F0F0)); border-radius:16px;height:16px;margin-right:-12px;margin-top:-7px;width:16px;top:50%;"></div></div></div><div style="margin-left:35px;display:inline-block;height:30px"><input style="width:60px;height:30px;text-align:center;border:solid 1px #dad8d7;padding:0 2px; height:30px;width:60px" value="100%"><div style="float:right;width:25px;height:30px"><div class="noselect" style="cursor:pointer;width:25px;text-align:center;line-height:14px;height:14px">+</div><div class="noselect" style="cursor:pointer;width:25px;text-align:center;line-height:14px;height:14px">-</div></div></div><br><hr></div>
                                                </div>
                                            </div>
