...
?>        <div class="content">
            <div class="top-nav">
                <div class="w1036">
                    ...
                    <a class="create-btn" href="http://act.aiwanpai.com/prizeResult?id=549#1">
                        新建活动
                    </a>
                </div>
            </div>
            <div class="content-wrap">
                <div class="w1036">
                    <ul class="step-show">
                        <li>
                            <a href="http://act.aiwanpai.com/basic?id=549">
                                <span>
                                    基本资料
                                </span>
                        ...
                        <li>
                            <a href="http://act.aiwanpai.com/gameChoose?id=549">
                                <span>
                                    选择游戏
                                </span>
                                <i class="icon-circle"></i>
                        ...
                        <li class="active">
                            <a href="http://act.aiwanpai.com/begin?id=549">
                                <span>
                                    营销元素
                                </span>
                                <i class="icon-circle"></i>
                        ...
                        <li>
                            <a href="http://act.aiwanpai.com/confirm?id=549">
                                <span>
                                    确认提交
                                </span>
                                <i class="icon-circle"></i>
                    ...
                    <div class="content-main">
                        <form class="comm-form">
                            <div class="top-menu">
                                <ul>
                                    <li class="current">
                                        <a href="./begame3_1?id=<?php echo $_GET['id']?>">
                                            <i class="icon"></i>
                                            活动开始
                                        </a>
                                    </li>
                                ...
                                </select><a href="javascript:;" class="select-target select-theme-default select-enabled select-abutted select-abutted-left select-element-attached-top select-element-attached-left select-target-attached-bottom select-target-attached-left" tabindex="0">iPhone4<b></b></a>
                            </div>
                                ...
                                <div class="left">
                                    <ul class="choice-layout">
                                        <li class="active lay1">
                                            <a href="javascript:;">
                                                <img src="./begame35_files/lay-common.png">
                                            </a>
                                        </li>
                                        <li class="lay2">
                                            <a href="javascript:;">
                                                <img src="./begame35_files/lay-vertical.png">
                                            </a>
                                        </li>
                                        <li class="lay3">
                                            <a href="javascript:;">
                                                <img src="./begame35_files/lay-symmetric.png">
                                            </a>
                                        </li>
                                    </ul>
                                    <div class="statusBar">
...
<div class="phone-simulation lay-common ui-droppable" data-layout="common" data-screen="1">
            ...
            <div class="layoutArea">
                <div class="prize-show">
                    <div class="prize-litpic hdp-img" data-tip="no-upload">
                        <img src="./begame35_files/litpic.jpg" id="prize-img">
                    </div>
                    <p class="hdp-textarea" data-input="false" style="color: #101010">
                                                                <span class="text-main" id="prizeName-text">可口可乐一箱</span>
                    </p>
                    ...
                    <div class="btnArea">
                        <a class="btn1 hdp-btn hdp-acceptPrize-btn" href="javascript:;">
                            立即领奖
                        ...
                        <a class="btn2 hdp-btn hdp-replay-btn" href="javascript:;">
                            再玩一次
                            <div class="btn-current">
                                <i class="btn-current-i tl"></i>
                                <i class="btn-current-i tr"></i>
                        ...
                        <a class="btn3 hdp-btn hdp-share-btn" href="javascript:;">
                            我要分享
                            <div class="btn-current">
                                <i class="btn-current-i tl"></i>
                                <i class="btn-current-i tr"></i>
                        ...
                        <a class="btn4 hdp-btn hdp-attention-btn" href="javascript:;" data-id="url" data-url="http://t.cn/RzZEU8M">
                            关注我们
                            <div class="btn-current">
                                <i class="btn-current-i tl"></i>
                                <i class="btn-current-i tr"></i>
                ...
                <div class="footerArea" style="position: absolute; left: 16px;">
                    <div class="copyright hdp-textarea">
                        <span class="text-main">由爱玩派提供技术支持</span>
                                    ...
                                    <div class="layout-set" id="bg-set" style="display: block">
                                        ...
                                        <ul class="set-nav tab" role="tablist" style="display: none;">
                                            <li role="presentation" class="active">
                                                <a href="http://act.aiwanpai.com/prizeResult?id=549#home" role="tab" data-toggle="tab">样式</a>
                                            </li>
                                            <li role="presentation">
                                                <a href="http://act.aiwanpai.com/prizeResult?id=549#profile" role="tab" data-toggle="tab">格式</a>
                                            </li>
                                            <li role="presentation">
                                                <a href="http://act.aiwanpai.com/prizeResult?id=549#messages" role="tab" data-toggle="tab">排序</a>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active" id="home">
                                                <div class="set-main">
                                                    <div id="target2"><br><br><div class="img-set webuploader-container"><div class="webuploader-pick">上传图片</div><div id="rt_rt_19hsjn5471r7h1l49k3qsaiued1" style="position: absolute; top: 0px; left: 0px; width: 220px; height: 48px; overflow: hidden; bottom: auto; right: auto;"><input type="file" name="file" class="webuploader-element-invisible"><label style="opacity: 0; width: 100%; height: 100%; display: block; cursor: pointer; background: rgb(255, 255, 255);"></label></div></div><hr><div class="setColor-label">背景颜色：</div><div class="inputArea" style="cursor:pointer;margin-top:1px;box-shadow:0 0 2px gray; border:3px solid rgb(250,250,250) ;display:inline-block;float:right;margin-left:20px;width:88px;height:30px;background:url(http://test.aiwanpai.com/managers/assets/css/res/nullcolor.jpg);border-radius:0px;"></div><br><hr><div class="setComn-label">旋转角度：</div><div class="toolbar" style="border-radius: 6px; display: inline-block; margin-top: 7px; margin-left: 0px; width: 100px; height: 6px; touch-action: pan-y; -webkit-user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); background-color: rgb(197, 197, 197);"><div class="toolprogress" style="cursor:pointer;border-radius:5px;top;0;left:-1px;height:100%;width:0%;"><div style="cursor:pointer;box-shadow: 0px 1px 4px #a0a0a0;float:right;box-shadow: 0px 1px 2px #a0a0a0;background:-webkit-gradient(linear, 0% 0%, 0% 80%, from(#FFFFFF), to(#F0F0F0));background:-moz-linear-gradient(top, #FFFFFF, #F0F0F0);background:-o-linear-gradient(top, #FFFFFF, #F0F0F0);background:-ms-linear-gradient(top, #FFFFFF, #F0F0F0); background:-webkit-gradient(linear, 0% 0%, 0% 80%,from(#FFFFFF), to(#F0F0F0)); border-radius:16px;height:16px;margin-right:-12px;margin-top:-7px;width:16px;top:50%;"></div></div></div><div style="margin-left:35px;display:inline-block;height:30px"><input style="width:60px;height:30px;text-align:center;border:solid 1px #dad8d7;padding:0 2px; height:30px;width:60px" value="0%"><div style="float:right;width:25px;height:30px"><div class="noselect" style="cursor:pointer;width:25px;text-align:center;line-height:14px;height:14px">+</div><div class="noselect" style="cursor:pointer;width:25px;text-align:center;line-height:14px;height:14px">-</div></div></div><br><hr><div class="setComn-label">模糊程度：</div><div class="toolbar" style="border-radius: 6px; display: inline-block; margin-top: 7px; margin-left: 0px; width: 100px; height: 6px; touch-action: pan-y; -webkit-user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); background-color: rgb(197, 197, 197);"><div class="toolprogress" style="cursor:pointer;border-radius:5px;top;0;left:-1px;height:100%;width:0%;"><div style="cursor:pointer;box-shadow: 0px 1px 4px #a0a0a0;float:right;box-shadow: 0px 1px 2px #a0a0a0;background:-webkit-gradient(linear, 0% 0%, 0% 80%, from(#FFFFFF), to(#F0F0F0));background:-moz-linear-gradient(top, #FFFFFF, #F0F0F0);background:-o-linear-gradient(top, #FFFFFF, #F0F0F0);background:-ms-linear-gradient(top, #FFFFFF, #F0F0F0); background:-webkit-gradient(linear, 0% 0%, 0% 80%,from(#FFFFFF), to(#F0F0F0)); border-radius:16px;height:16px;margin-right:-12px;margin-top:-7px;width:16px;top:50%;"></div></div></div><div style="margin-left:35px;display:inline-block;height:30px"><input style="width:60px;height:30px;text-align:center;border:solid 1px #dad8d7;padding:0 2px; height:30px;width:60px" value="0级"><div style="float:right;width:25px;height:30px"><div class="noselect" style="cursor:pointer;width:25px;text-align:center;line-height:14px;height:14px">+</div><div class="noselect" style="cursor:pointer;width:25px;text-align:center;line-height:14px;height:14px">-</div></div></div><br><hr></div>
                                                </div>
                                            </div>
                            ...
                            <div class="submit-group">
                                <a class="reset" href="javascript:;" data-url="http://act.aiwanpai.com/prizeResult/save.json">
                                    重置数据
                                </a>
                    ...
                    <div id="footer">
                        Copyright © 爱玩派www.aiwanpai.com，All Rights Reserved
                    </div>
                </div>
            </div>
        </div>
