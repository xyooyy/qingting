                        ...
                        <form class="comm-form">
                            <div class="top-menu">
                                ...
                                <select name="screen" class="select-select">
                                    ...
                                    <option value="3">iPhone6</option>
                                            ...
                                            class="select-target select-theme-default select-enabled select-abutted select-abutted-left select-element-attached-top select-element-attached-left select-target-attached-bottom select-target-attached-left"
                                            tabindex="0">iPhone4<b></b></a>
                            </div>
                                        ...
                                        <div class="set-select">
                                            <select name="set-way" class="select-select">
                                                ...
                                                <option value="2">自定义设置</option>
                                                        ...
                                                        class="select-target select-theme-default select-enabled select-element-attached-top select-element-attached-left select-target-attached-bottom select-target-attached-left"
                                                        tabindex="0">一键设置<b></b></a>
                                        </div>
                                        <div class="btns">
                                            <div id="filePicker2"></div>
                                            <a class="uploadBtn state-ready" href="javascript:;"
                                               data-name="alreadyWinning">
                                                保存设置
                                            </a>
                                        </div>
                                    </div>
                                                ...
                                                <div class="layoutbox" style="height: 100%; width: 100%;">
                                                    <div class="layoutArea">
                                                        <div class="prize-show">
                                                            ...
                                                            <div class="btnArea">
                                                                <a class="btn1 hdp-btn hdp-acceptPrize-btn"
                                                                   href="javascript:;">
                                                                    立即领奖
                                                                ...
                                                                <a class="btn4 hdp-btn hdp-attention-btn"
                                                                   href="javascript:;" data-id="url"
                                                                   data-url="http://t.cn/RzZEU8M">
                                                                    关注我们
                                                                    <div class="btn-current">
                                                                        <i class="btn-current-i tl"></i>
                                                                        <i class="btn-current-i tr"></i>
                            ...
                            <div class="submit-group">
                                <a class="reset" href="javascript:;"
                                   data-url="http://act.aiwanpai.com/prizeResult/save.json">
                                    重置数据
                                </a>
