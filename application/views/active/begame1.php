       ...
       <div class="content-main"> 
        <form class="comm-form" action="./active_submit" method="post">
         ...
         <div class="form-group"> 
          <label> 活动名称 </label> 
          <input class="input-class input-name" type="text" name="actName" value="<?php echo $val['title']?>" /> 
          <div class="prompt"> 
         ...
         <div class="form-group"> 
          <div class="form-date form-fl"> 
           <label>开始时间</label> 
           <input class="input-class date-picker" type="text" name="startTime" value="<?php echo $val['starttime']?date('Y-m-d H:i',$val['starttime']):date('Y-m-d H:i',time())?>" autocomplete="on" readonly="" /> 
         ...
         <div class="form-group form-group-check"> 
          <label>选择商业场景</label> 
          <div> 
          <input type="radio" name="scene"  value="1" <?php echo $val['type']==1?'checked':'';?>  data-id="1"/>&nbsp;品牌传播&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="radio" name="scene"  value="2" <?php echo $val['type']==2?'checked':'';?> data-id="2"/>&nbsp;微信关注&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="radio" name="scene"  value="3" <?php echo $val['type']==3?'checked':'';?> data-id="3"/>&nbsp;商城引流&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="radio" name="scene"  value="4" <?php echo $val['type']==4?'checked':'';?> data-id="4"/>&nbsp;线下导流&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="radio" name="scene"  value="5" <?php echo $val['type']==5?'checked':'';?> data-id="5"/>&nbsp;展会活动&nbsp;&nbsp;&nbsp;&nbsp; 
          </div> 
         ...
         <div class="commercial-content"> 
          ...
          <div class="form-group"> 
           <label> 是否设活动奖品 </label> 
           <div> 
             <input type="radio" name="ischou"  value="1" <?php echo $val['ischou']==1?'checked':'';?>  data-id="1"/>&nbsp;需要&nbsp;&nbsp;&nbsp;&nbsp;
             <input type="radio" name="ischou"  value="0" <?php echo $val['ischou']==0?'checked':'';?> data-id="0"/>&nbsp;不需要&nbsp;&nbsp;&nbsp;&nbsp;
           </div> 
         ...
         <div class="wx-share"> 
          <div class="form-group"> 
           <label> 微信分享标题 </label> 
           <input class="input-class input-name" type="text" name="wxTitle" value="<?php echo $val['fenxiangt']?>" />*如需获取分数的部分写入'#score#' 
          </div> 
          <div class="form-group" style="height:auto"> 
           <label>微信分享描述</label> 
           <textarea class="form-textarea" placeholder="建议文本描述不要过长" name="wxDesc"><?php echo $val['fenxiangc']?></textarea> 
          </div> 
          <div class="form-group form-group-check"> 
           <label> 微信分享缩图 </label> 
           <div class="form-single-upload wx-avatar-upload"> 
            <div class="form-fileupload litpci-load" style="height:200px;width:200px;"> 
             <img src="<?php echo $val['fenxiangi']?'http://qingting.huosu.com'.$val['fenxiangi']:'/public/images/s.png'?>"  id="now_img"/> 
             ...
             <div class="inner bg" style="display: none;"> 
              ...
              <div class="picker webuploader-container">
               ...
               <div id="rt_rt_19hscv7ca1bmcif0bin1htlmk51" style="position: absolute; top: 0px; left: 0px; width: 110px; height: 40px; overflow: hidden; bottom: auto; right: auto;">
          ...
          <div class="yesOrNo"> 
           <div class="form-group"> 
            ...
            <div class="iradio_polaris">
             <input type="radio" name="liveErnieActivity.repeatedlyWinning" value="1" data-id="1" style="position: absolute; opacity: 0;" />
             <ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);"></ins>
            </div> 
            <span class="options">允许</span> 
            <div class="iradio_polaris checked">
             <input type="radio" name="liveErnieActivity.repeatedlyWinning" value="0" data-id="2" checked="" style="position: absolute; opacity: 0;" />
             <ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);"></ins>
            </div> 
              ...
              <div class="form-fileupload litpci-load" style="height:200px;width:200px;"> 
               ...
               <div class="inner"> 
                ...
                <div class="picker webuploader-container">
                 ...
                 <div id="rt_rt_19hscv7cej4e1onfe1ef518l34" style="position: absolute; top: 0px; left: 0px; width: 110px; height: 40px; overflow: hidden; bottom: auto; right: auto;">
                  <input type="file" name="file" class="webuploader-element-invisible" accept="image/*" />
                  <label style="opacity: 0; width: 100%; height: 100%; display: block; cursor: pointer; background: rgb(255, 255, 255);"></label>
                 </div>
                </div> 
         ...
         <div class="submit-group"> 
          <a class="next" href="javascript:;" onClick="$('#fimg').val($('#now_img').attr('src'));"> 下一步 </a> 
         </div>
   ...
   <div class="xdsoft_datepicker active">
    ...
    <div class="xdsoft_calendar">
     <table>
      ...
      <tbody>
       <tr>
        <td data-date="29" data-month="2" data-year="2015" class="xdsoft_date xdsoft_day_of_week0 xdsoft_date xdsoft_other_month xdsoft_weekend">
         <div>
          29
         </div></td>
        <td data-date="30" data-month="2" data-year="2015" class="xdsoft_date xdsoft_day_of_week1 xdsoft_date xdsoft_other_month">
         <div>
          30
         </div></td>
        <td data-date="31" data-month="2" data-year="2015" class="xdsoft_date xdsoft_day_of_week2 xdsoft_date xdsoft_other_month">
         <div>
          31
         </div></td>
        <td data-date="1" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week3 xdsoft_date">
         <div>
          1
         </div></td>
        <td data-date="2" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week4 xdsoft_date xdsoft_current xdsoft_today">
         <div>
          2
         </div></td>
        <td data-date="3" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week5 xdsoft_date">
         <div>
          3
         </div></td>
        <td data-date="4" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week6 xdsoft_date xdsoft_weekend">
         <div>
          4
         </div></td>
       </tr>
       <tr>
        <td data-date="5" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week0 xdsoft_date xdsoft_weekend">
         <div>
          5
         </div></td>
        <td data-date="6" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week1 xdsoft_date">
         <div>
          6
         </div></td>
        <td data-date="7" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week2 xdsoft_date">
         <div>
          7
         </div></td>
        <td data-date="8" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week3 xdsoft_date">
         <div>
          8
         </div></td>
        <td data-date="9" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week4 xdsoft_date">
         <div>
          9
         </div></td>
        <td data-date="10" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week5 xdsoft_date">
         <div>
          10
         </div></td>
        <td data-date="11" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week6 xdsoft_date xdsoft_weekend">
         <div>
          11
         </div></td>
       </tr>
       <tr>
        <td data-date="12" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week0 xdsoft_date xdsoft_weekend">
         <div>
          12
         </div></td>
        <td data-date="13" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week1 xdsoft_date">
         <div>
          13
         </div></td>
        <td data-date="14" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week2 xdsoft_date">
         <div>
          14
         </div></td>
        <td data-date="15" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week3 xdsoft_date">
         <div>
          15
         </div></td>
        <td data-date="16" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week4 xdsoft_date">
         <div>
          16
         </div></td>
        <td data-date="17" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week5 xdsoft_date">
         <div>
          17
         </div></td>
        <td data-date="18" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week6 xdsoft_date xdsoft_weekend">
         <div>
          18
         </div></td>
       </tr>
       <tr>
        <td data-date="19" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week0 xdsoft_date xdsoft_weekend">
         <div>
          19
         </div></td>
        <td data-date="20" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week1 xdsoft_date">
         <div>
          20
         </div></td>
        <td data-date="21" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week2 xdsoft_date">
         <div>
          21
         </div></td>
        <td data-date="22" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week3 xdsoft_date">
         <div>
          22
         </div></td>
        <td data-date="23" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week4 xdsoft_date">
         <div>
          23
         </div></td>
        <td data-date="24" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week5 xdsoft_date">
         <div>
          24
         </div></td>
        <td data-date="25" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week6 xdsoft_date xdsoft_weekend">
         <div>
          25
         </div></td>
       </tr>
       <tr>
        <td data-date="26" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week0 xdsoft_date xdsoft_weekend">
         <div>
          26
         </div></td>
        <td data-date="27" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week1 xdsoft_date">
         <div>
          27
         </div></td>
        <td data-date="28" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week2 xdsoft_date">
         <div>
          28
         </div></td>
        <td data-date="29" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week3 xdsoft_date">
         <div>
          29
         </div></td>
        <td data-date="30" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week4 xdsoft_date">
         <div>
          30
         </div></td>
        <td data-date="1" data-month="4" data-year="2015" class="xdsoft_date xdsoft_day_of_week5 xdsoft_date xdsoft_other_month">
         <div>
          1
         </div></td>
        <td data-date="2" data-month="4" data-year="2015" class="xdsoft_date xdsoft_day_of_week6 xdsoft_date xdsoft_other_month xdsoft_weekend">
         <div>
          2
         </div></td>
       </tr>
     ...
     <table>
      ...
      <tbody>
       <tr>
        ...
        <td data-date="2" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week4 xdsoft_date xdsoft_today">
         <div>
          2
         </div></td>
        <td data-date="3" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week5 xdsoft_date">
       ...
       <tr>
        ...
        <td data-date="9" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week4 xdsoft_date xdsoft_current">
         <div>
          9
         </div></td>
        <td data-date="10" data-month="3" data-year="2015" class="xdsoft_date xdsoft_day_of_week5 xdsoft_date">
