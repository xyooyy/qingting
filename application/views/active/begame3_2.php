                    ...
                    <div class="content-main">
                        <form class="comm-form">
                            ...
                            <div class="act-step3" id="uploader">
                                ...
                                <div class="mid">
                                    <div class="phone" unselectable="on" onselectstart="return false;" style="width: 320px; height: 480px; -webkit-user-select: none;">
                                            <div class="phone-simulation lay-common ui-droppable" data-layout="common" data-screen="1">
                                                <div class="layoutBg hdp-layoutBg" style="position: relative; height: 100%;">
                                                    <div class="footerArea" style="z-index: 99; position: absolute; bottom: 0px; left: 16px;">
                                                ...
                                                <div class="layoutAuto">
                                                    ...
                                                    <div class="layoutArea">
                                                        <div class="layoutArea">
                                                            ...
                                                            <div class="btnArea">
                                                                 <a class="btn1 hdp-btn hdp-lottery-btn" data-id="url" data-url="<?php echo $ischou==1?'http://qingting.huosu.com/active/games_choujiang?id='.$_GET['id']:'#'?>" href="javascript:;fenxiang">
                                                                ...
                                                                <a class="btn3 hdp-btn hdp-attention-btn" href="javascript:;" data-id="url" data-url="#">
                                                                    关注我们
                                                                    <div class="btn-current">
                                                                        <i class="btn-current-i tl"></i>
                                                                        <i class="btn-current-i tr"></i>
                                    ...
                                    <div class="layout-set" id="bg-set" style="display: block">
                                        ...
                                        <ul class="set-nav tab" role="tablist" style="display: none;">
                                            <li role="presentation">
                                                <a href="http://act.aiwanpai.com/end?id=581#home" role="tab" data-toggle="tab">样式</a>
                                            </li>
                                            <li role="presentation" class="active">
                                                <a href="http://act.aiwanpai.com/end?id=581#profile" role="tab" data-toggle="tab">格式</a>
                                            </li>
                                            <li role="presentation">
                                                <a href="http://act.aiwanpai.com/end?id=581#messages" role="tab" data-toggle="tab">排序</a>
                                            </li>
                                        </ul>
