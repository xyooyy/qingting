...
<div class="con">
    ...
    <div class="game_link">
        <div class="link_head">
            <input type="button" class="del_button" value="删除"/>
            <input type="button" class="add_button" value="新增投放点"/>
        </div>
        <table class="link_table">
            ...
            <tr>
                ...
                <td width="7%"><img src="/public/images/erweima.jpg" width="40" height="40"/><img
                        src="/public/images/21.png" style="margin-left:1em;"/></td>
