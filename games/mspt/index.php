...
<div  id="gameresult">
	<div class="resultcontainer">
		...
		<div class="btngroup">
			...
			<a class="btn1" id="sharegame" onClick="dp_share();"><?php echo $row['fenxiang']?></a>
		</div>
		<div class="btngroup">
			<a class="btn1" onClick="clickMore();"><?php echo $row['moregame']?></a>
		</div>
	</div>
</div>
    ...
    e("data/jigsawGame", function(e, t, n) {
        n.exports = [{
            ...
            ka: [{
                ...
                pic: [{
                    ...
                    img: "<?php echo $row['img'][1]['val']?>",
                    row: 3,
					type: 2,
                    second: 35,
                    column: 3
                },{
                    img: "<?php echo $row['img'][2]['val']?>",
                    row: 3,
					type: 2,
                    second: 30,
                    column: 3
                },{
                    img: "<?php echo $row['img'][3]['val']?>",
                    row: 3,
					type: 2,
                    second: 25,
                    column: 3
                },{
                    img: "<?php echo $row['img'][4]['val']?>",
                    row: 3,
					type: 2,
                    second: 20,
                    column: 3
                },{
                    img: "<?php echo $row['img'][5]['val']?>",
                    row: 4,
					type: 2,
                    second: 50,
                    column: 4
                },{
                    img: "<?php echo $row['img'][6]['val']?>",
                    row: 4,
					type: 2,
                    second: 45,
                    column: 4
                },{
                    img: "<?php echo $row['img'][7]['val']?>",
                    row: 4,
					type: 2,
                    second: 35,
                    column: 4
                },{
                    img: "<?php echo $row['img'][8]['val']?>",
                    row: 4,
					type: 2,
                    second: 25,
                    column: 4
                },{
                    img: "<?php echo $row['img'][9]['val']?>",
                    row: 4,
					type: 2,
                    second: 20,
                    column: 4
        ...
        p.init = function(e) {
            ...
            e.html(t), p.jigsawGame = s, p.jigsawGame.init(e), p.dom = e, p.jigsawGame.on("picOver", function(e) {
				...
				var str="<?php echo $row['text2'];?><em>"+(p.currentGame.pic+1)+"</em>关";
				if(!p.hasNextPic()){
...
var thegameurl ="<?php echo 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'].'?'.$_SERVER['QUERY_STRING'];?>"; 
var guanzhuurl ="<?php echo $row['moregameh']?>";
		window.shareData = {
		        "imgUrl": "<?php echo $row['icon']?>",
		        "timeLineLink": thegameurl,
		        "tTitle": "<?php echo $row['text1']?>",
		        "tContent": "<?php echo $row['text2']?>"
		};
