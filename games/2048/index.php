...
HTMLActuator.prototype.tileHTML = ["<?php echo $row['text'][0]['val']?>", "<?php echo $row['text'][1]['val']?>", "<?php echo $row['text'][2]['val']?>", "<?php echo $row['text'][3]['val']?>", "<?php echo $row['text'][4]['val']?>", "<?php echo $row['text'][5]['val']?>", "<?php echo $row['text'][6]['val']?>", "<?php echo $row['text'][7]['val']?>", "<?php echo $row['text'][8]['val']?>", "<?php echo $row['text'][9]['val']?>", "<?php echo $row['text'][10]['val']?>"];
