...
<style>
        ...
        .sbg p{ z-index:10002; padding-top:78px;}s
    </style>	
	</head>
	<body>
		<input id="bt-game-id" type="hidden" value="6-mengwazainali">
		<canvas id="stage">
...
<script language=javascript>
		var mebtnopenurl = 'http://more.aiwanpai.com/';
		window.shareData = {
		        "imgUrl": "http://more.aiwanpai.com/youxi/mwzne/icon.png",
		        "timeLineLink": "http://more.aiwanpai.com/youxi/mwzne/",
		        "tTitle": "萌娃在哪儿",
		        "tContent": "宝贝儿，宝贝儿，你们都在那里呢？"
		};
		...
		function clickMore(){
			if((window.location+"").indexOf("f=zf",1)>0){
				window.location = "http://more.aiwanpai.com/";
			 }
			 else{
				goHome();
			 }
		...
		<div id=share style="display: none">
			...
			function dp_submitScore(score){
						...
						myData.scoreName ="找到"+score+"对萌娃";		
						document.title = window.shareData.tTitle = "我在【萌娃在哪里】找到"+score+"对萌娃！,有本事来挑战一下，嘻嘻！";
			}
