...
http-equiv="X-UA-Compatible">
     <TITLE><?php echo $row['text'][0]['val']?></TITLE>     
<META charset="utf-8">	 
...
<STYLE type="text/css">
    ...
    .t1,.t2,.t3,.t4,.t5 { background-size:auto 100%;background-image:url(<?php echo $row['img'][0]['val'];?>);}
    .tt1,.tt2,.tt3,.tt4,.tt5 { background-size:auto 86%;background-image:url(<?php echo $row['img'][1]['val'];?>);}
...
<SCRIPT type="text/javascript">
	window.shareData = {
	        ...
	        "timeLineLink": "echo 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'].'?'.$_SERVER['QUERY_STRING'];",
	        "tTitle": "<?php echo $row['title']?>",
	        "tContent": "<?php echo $row['fenxiangc']?>！"
	    };
	...
	function showGameScoreLayer(){
		...
		window.shareData.tTitle = '我去！我刚捡到了'+_gameScore*100+'，财运强过'+num+'人！'
	}
	...
	function shareText( score ){
		if( score <= 50 )
			return '财运不错，捡到了'+score+'<?php echo $row['text3']?>！<br/><img src="<?php echo $row['img3']?>" /><br/>离土豪又近了一步！';
		if( score <= 120 )
			return '财神到，捡到了'+score+'<?php echo $row['text3']?>！<br/><img src="<?php echo $row['img3']?>" /><br/>离土豪又近了一步！';
		if( score <= 150 )
			return '帅呆了！捡到'+score+'<?php echo $row['text3']?>！<br/><img src="<?php echo $row['img3']?>" /><br/>离土豪又近了一步！';
		if( score <= 199 )
			return '太牛了！捡到'+score+'<?php echo $row['text3']?>！<br/><img src="<?php echo $row['img3']?>" /><br/>离土豪又近了一步！';

		return '哈哈哈哈哈，捡到'+score+'<?php echo $row['text3']?>！<br/><img src="<?php echo $row['img3']?>" /><br/>土豪的世界你们不懂！！';
	}
...
<DIV class="btn BOX-S" onClick="share()"><?php echo $row['fenxiang']?></DIV>&nbsp;			</DIV><BR>
</DIV></DIV>
...
<DIV style="color: rgb(254, 240, 2); font-size: 2.6em;"><?php echo $row['text'][0]['val']?></DIV><BR>
<DIV 
style="color: rgb(255, 255, 255); line-height: 1.5em; font-size: 2.2em;"> <?php echo $row['text'][1]['val']?></DIV><BR><BR>
