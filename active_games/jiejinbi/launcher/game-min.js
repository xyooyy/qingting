...
var __extends = this.__extends || function (d, e) {
    ...
    e.fenxiang = function () {
//        console.log("WeixinAPI start ..");
        if (XiaobinTool.GAME_SCORE > 0 && count == 0){
            count++;
            document.getElementById('gameCanvas').style.visibility = 'hidden';
            gameOverHandlerFunction(XiaobinTool.GAME_SCORE);
        }
//        window.shareData.tTitle = "\u6211\u63a5\u5230\u4e86" + XiaobinTool.GAME_SCORE + "\u4e2a\u91d1\u5e01\uff0c\u5c0f\u4f19\u4f34\u4eec\u5feb\u6765\u8bd5\u8bd5\u5427\uff01";
//        WeixinApi.ready(function (d) {
//            var c = new WeixinShareInfo;
//            c.title = "\u5c0f\u9ec4\u4eba\u63a5\u91d1\u5e01";
//            c.desc =
//            c.link = "http://h.4399.com/zzy/143399.htm";
//            c.imgUrl = "icon.jpg";
//            d.shareToFriend(c);
//            d.shareToTimeline(c)
//        })
...
var __extends = this.__extends || function (d, e) {
    ...
    e.prototype.loop =
        function (d) {
            this.gameStart && (!1 == this.gameOver ? (this.checkMove(), this.creatDroper(), this.makeDrop(), this.checkHit(), this.checkOut(), this.checkHard(), this.checkGameOver(), this.timeBar.graphics.clear(), this.timeBar.graphics.beginFill(255, 1), this.timeBar.graphics.drawRect(0, 0, (3600 - this.gameTime) / 3600 * 480, 10), this.timeBar.graphics.endFill(), XiaobinTool.GAME_SCORE = this.scoreNum.toString()) : this.makeGameOver())
        };
    e.prototype.checkGameOver = function () {
        !1 == this.gameOver && (3600 < this.gameTime ? this.gameOver = !0 : this.gameTime++)
    };
...
//
    ...
    e.prototype.setText = function () {
        this.gameOverTxt.text = "\u4f60\u63a5\u4e86" + this.scoreNum + "\u4e2a\u91d1\u5e01\uff0c\u5206\u4eab\u8ddf\u597d\u53cb\u70ab\u8000\u4e00\u4e0b\u5427~";
    ...
    e.prototype.creatStartBtn = function () {
        ...
        this.startBtn.y = this.stageH - 300;
